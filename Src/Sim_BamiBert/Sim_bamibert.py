...
embedding_output = r'D:\MGEEMS\Test\Similarity\Sim_BamiBERT\Embedding_bamibert.txt'
similarity_output = r'D:\MGEEMS\Test\Similarity\Sim_BamiBERT\SimBamiBERT.txt'
...
df['bamibert_similarity'] = similarities
print(f"\nDone! Computed {len(similarities)} BamiBERT similarity scores")
print(f"Saved to {similarity_output}")
print(f"\nSample results:")
print(df[[col_g1, col_g2, 'bamibert_similarity']].head(10).to_string(index=False))